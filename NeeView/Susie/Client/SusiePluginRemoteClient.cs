...
namespace NeeView.Susie.Client
{
    public class SusiePluginRemoteClient : IDisposable
    {
        ...
        public void Connect()
        {
            ...
            {
                subProcessFileName = Path.GetFullPath(Path.Combine(Environment.AssemblyFolder, @"..\..\..\..\..\NeeView.Susie.Server\bin", Environment.ConfigType, @"net9.0\NeeView.Susie.Server.exe"));
            }
